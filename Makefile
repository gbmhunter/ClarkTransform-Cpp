...
# All
all: clarkTransformLib test example
	
	# Run unit tests:
	@./test/ClarkTransformTest.elf

#======== CLIDE LIB ==========	

clarkTransformLib : $(SRC_OBJ_FILES)
	# Make Clide library
	ar r libClarkTransform.a $(SRC_OBJ_FILES)
...
test : $(TEST_OBJ_FILES) | clarkTransformLib unitTestLib
	# Compiling unit test code
	g++ $(TEST_LD_FLAGS) -o ./test/ClarkTransformTest.elf $(TEST_OBJ_FILES) -L./lib/UnitTest++ -lUnitTest++ -L./ -lClarkTransform
...
example : $(EXAMPLE_OBJ_FILES) clarkTransformLib
	# Compiling example code
	g++ $(EXAMPLE_LD_FLAGS) -o ./example/example.elf $(EXAMPLE_OBJ_FILES) -L./ -lClarkTransform
...
clean-clark:
	...
	@echo " Cleaning clark-transform static library..."; $(RM) ./*.a
	@echo " Cleaning test object files..."; $(RM) ./test/*.o
